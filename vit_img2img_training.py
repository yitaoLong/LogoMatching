...
state_dict['vit.embeddings.position_embeddings'] = torch.rand(1, 3, 768)

configuration = ViTConfig(image_size=(64,32), patch_size=32, label2id=label2id, id2label=id2label)
